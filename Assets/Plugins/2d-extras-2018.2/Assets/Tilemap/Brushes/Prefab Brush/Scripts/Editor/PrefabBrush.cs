...
namespace UnityEditor
{
	...
	public class PrefabBrush : GridBrushBase
	{
		...
		{
            if (brushTarget == null) brushTarget = GameObject.Find("SpikesLayer");
			...
			if (instance != null)
			{
				...
				instance.transform.position = grid.LocalToWorld(grid.CellToLocalInterpolated(new Vector3Int(position.x, position.y, m_Z) + new Vector3(.5f, 0f, .5f)));
			}
            Debug.LogError("s");
        }
